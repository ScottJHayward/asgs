...
INSTANCENAME=sdogtestec95d      # name of this ASGS process (Change this for every new instance)
COLDSTARTDATE=2019062100  # (date to start cold start from )
...
H=/home/ycme
W=/work/ycme
ADCIRCDIR=${H}/adcirc-cg/work
SCRIPTDIR=${W}/asgs       # ASGS scripts/executables  
...
QUEUENAME=B30
SERQUEUE=B30
SCRATCHDIR=/work/ycme/asgs-scratch/nam_ec95
...
ems="scott.hayward@ransomenv.com"
